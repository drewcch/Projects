        ...
        <Grid>
          ...
          <Cell className="resume-right-col" col={8}>
            ...
            <Experience
              ...
              startDate2="June 2015 —"
              endDate2="August 2015"
              jobName="Software Engineer Intern"
              jobLocation="Nova Biomedical — Waltham, MA"
              jobDescription="Conducted asynchronous client socket communication with a critical care analyzer. Used Wireshark, a tool to analyze source packets of information exchanged, to help create a demo software of primary analyzer functions in accordance to its specifications."
              jobDescription2="Identified errors within the software of a critical care analyzer. Proceeded to fix errors within the requirements document for the analyzer that consisted of incorrect or mismatched information between the requirements document and analyzer screen."
            />
            <Experience
