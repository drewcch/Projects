            ...
            <Card shadow={5} style={{ minWidth: "450", margin: "auto" }}>
              <CardTitle
                style={{
                  ...
                  height: "176px",
                  background:
                    "url(http://www.gpsnavigationconnection.com/wp-content/uploads/2018/03/GPS.png) center / cover"
                }}
              >
                GPS Project
              </CardTitle>
              ...
              <CardActions border>
                <Button colored>
                  <a
                    href="https://github.com/drewcch/Projects/tree/master/MapQuest%20Project"
                    target="_blank"
                  >
                    GitHub
                  </a>
